...
filtered_dataset <- filter(dataset_info, full_citation != "")  #only print the dataset that have a full citation
## print((filtered_dataset))
## format: full_citation [Paper](link to link_fields)
```

<!-- 
`r filtered_dataset$full_citation` and this is the paper [[Paper]](`r filtered_dataset$link`)

paste(filtered_dataset$full_citation, "and this is the paper") -->


`r for(i in filtered_dataset) {
  print(filtered_dataset$full_citation[i])
  print(filtered_dataset$link[i])
  }`
