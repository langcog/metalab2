...
note: |  
  Correspondence concerning this article should be addressed to Molly Lewis, email: mollylewis@uchicago.edu.
...
from `r sum(datasets$num_papers)`papers, `r sum(datasets$num_experiments)` different conditions and `r format(floor(sum(datasets$num_subject)), big.mark=",", scientific=FALSE)` participants. The
...
studies are likely to be less biased than qualitative methods [@valentine2010many].
