...
\begin{table}[h!]
    ...
    \begin{tabular}{lp{4cm} p{5cm}r}
        ...
        Prosody        & IDS  preference  \newline  {\scriptsize (Dunst, Gorman, \& Hamby, 2012)}          & {\scriptsize  Looking times as a function of whether infant-directed vs. adult-directed speech is presented as stimulation.}             & 4 (18)                         \\
        Sounds         & Phonotactic learning  \newline {\scriptsize (Cristia, in prep.)}                  & {\scriptsize Infants' ability to learn phonotactic generalizations from a short exposure.  }       & 6 (21)               \\
        ~              & Vowel discrimination (native) \newline {\scriptsize (Tsuji \& Cristia, 2014)}     & {\scriptsize Discrimination of native-language vowels, including results from a variety of methods.  }    & 18 (70)         \\ 
        ~              & Vowel discrimination (non-native) \newline {\scriptsize (Tsuji \& Cristia, 2014)} & {\scriptsize Discrimination of non-native vowels, including results from a variety of methods.  } & 8 (32)   \\
                       & Statistical sound learning  \newline {\scriptsize (Cristia, in prep.)}            & {\scriptsize Infants' ability to learn sound categories from their acoustic distribution.   }            & 3 (7)                           \\ 
                       & Word segmentation \newline {\scriptsize  (Bergmann \& Cristia, 2015) }            & {\scriptsize Recognition of familiarized words from running, natural speech using behavioral methods.  }           & 27 (90)                       \\
        ...
        & 3 (18)             \\
        ~              & Concept-label advantage   \newline {\scriptsize (Lewis \& Long, unpublished)}     & {\scriptsize Infants' categorization judgments in the presence and absence of labels.    }           & 5 (14)                           \\
        ~              & Online word recognition \newline {\scriptsize (Frank, Lewis, \& MacDonald, 2016)} & {\scriptsize Online word recognition of familiar words using two-alternative forced choice preferential looking.   }  & 3 (10)       \\
        Communication  & Gaze following  \newline {\scriptsize  (Frank, Lewis, \& MacDonald, 2016)}        & {\scriptsize Gaze following using standard multi-alternative forced-choice paradigms.   }    & 9 (30)           \\
        ~              & Pointing and vocabulary  \newline {\scriptsize (Colonnesi et al., 2010)}          & {\scriptsize }  &  () \\ 
        \bottomrule
    \end{tabular}
...
IDS preference & 0.74 [0.47, 1.01] & 1439 & 3.11* & -3.51*\\
Phonotactic learning & -0.04 [-0.22, 0.14] & \$dagger\$ & -0.8 & -0.89\\
Vowel discrim. (native) & 0.5 [0.39, 0.61] & 4190 & 7.05* & -5.13*\\
Vowel discrim. (non-native) & 0.39 [0.16, 0.63] & 1414 & 5.6* & -7.73*\\
Statistical sound learning & 0.16 [-0.01, 0.34] & \$dagger\$ & -1.94 & 0.36\\
Word segmentation & 0.22 [0.14, 0.31] & 2191 & 4.19* & -5.56*\\
Mutual exclusivity & 0.93 [0.5, 1.36] & 4395 & 10.31* & -11.96*\\
Sound symbolism & 0.02 [-0.13, 0.17] & 8 & -0.45 & -4.64*\\
Concept-label advantage & 0.45 [0.16, 0.75] & 618 & -0.11 & -3.48*\\
Online word recognition & 1.34 [0.64, 2.05] & 1390 & 4.26* & -11.9*\\
Gaze following & 1.28 [0.92, 1.63] & 4023 & 5.88* & -18*\\
...
2,185) in order for the overall effect sizes to be 0. Thus, while it is
...
\begin{figure}[htbp]
\centering
\includegraphics{metalab_synthesis_age_subset_files/figure-latex/unnamed-chunk-2-1.pdf}
...
studies. Figure 1 presents funnel plots for each of our 11
...
\begin{figure}[htbp]
\centering
\includegraphics{metalab_synthesis_age_subset_files/figure-latex/p_curve_plots-1.pdf}
...
Figure 2 shows p-curves for each of our 11 meta-analyses. All p-curves
...
from 95 papers, 351 different conditions and 5,143 participants. The
