...
fullWidthPanelBox(
  "Source code",
  HTML("The source for this website can be found <a href='https://github.com/langcog/metalab2/'>on GitHub</a>. The website itself is hosted through GitHub Pages, with the accompanying visualizations hosted on a Shiny server.<br/><br/>Many thanks to <a href='https://deanattali.com/'>AttaliTech Ltd</a> for website redesign.")
)
```
